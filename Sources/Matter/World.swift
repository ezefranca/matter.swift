...
public enum MatterError: Error, Sendable, Equatable {
    ...
    /// A bounded event stream requested fewer than one retained result.
    ...
    /// Compound parts were missing, nested, or had an invalid local transform.
    case invalidCompound
